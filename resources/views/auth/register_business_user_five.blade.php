    ...
    <div class="row">
      <div class="col-12">
        <div class="registration_main">
          ...
          <form method="POST" class="dropzone" id="my-awesome-dropzone" action="{{ url('/business_user/register_five/'.$id) }}" enctype="multipart/form-data">
          @csrf 
            <div class="registration_filed">
                          ...
                          <div class="form-group col-md-6 col-12">
                            <div class="formcheck forcheckbox">
                                  <label>
                                    ...
                                    <p>Send me questions to answer</p><img class="info" src="{{ asset('img/ing.png') }}" title="Check this checkbox if you want to send question.">
                                  </label>
                            </div>
                          </div>
                          <div class="form-group col-md-6 col-12">
                            <div class="formcheck forcheckbox">
                              <label>
                                ...
                                <span class="outside outside_checkbox"><span class="inside inside_checkbox"></span></span>
                                <p> Send me schedule requests</p><img class="info" src="{{ asset('img/ing.png') }}" title="Check this checkbox if you want to send schedule requests.">
                              </label>
                          </div>
                        </div>
                      </div>
                ...
                <div class="next_back_button">
                  <div class="back"><a href="{{ url('/business_user/register_four/'.$id) }}">< Back</a></div>
                 <!--  <div class="next"><a href="{{ url('/business_user/register_six/'.$id) }}">Skip</a></div> -->
