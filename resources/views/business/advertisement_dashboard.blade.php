...
<section class="register_step_1">
  <div class="breadcrumb register_breadcrumb advertisment_breadcrumb">
    <div>
      <a href="JavaScript:;">Dashboard</a>/<a href="JavaScript:;">Advertisement</a>/<span class="q_breadcrumb">Start pro mode</span>
    </div>
    <div class="setup_things"><a href="javascript:;">How to set things up?</a></p>
    </div>
  </div>
</section>
          ...
          <div class="col-md-3 col-6 padding_rt">
            <div class="dashboard_box">
              <a href="javascript:;" class="budget_left_bg">
                ...
                <div class="total_number">
                  <h1>$@if(isset($monthlyBudget['updated_wallet_amount']) && !empty($monthlyBudget['updated_wallet_amount'])){{$monthlyBudget['updated_wallet_amount']}}@endif</h1>
                </div>
