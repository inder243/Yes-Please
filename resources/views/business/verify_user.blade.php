...
<section>
  <div class="quote_req_main">
    <h1>Verification</h1>
    <form method="POST" class="dropzone" id="dropzone_form" data-page="verifyuser" action="{{ url('/business_user/verify') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="verfication_pts">
      <h1>Why to verify?</h1>
      <ul>
        <li><b>1.</b>When verified you'll have a verified badge on business list. <img src="{{ asset('img/info.png') }}"/></li>
