...
<head>
   ...
   <!--  <link href="{{ URL::asset('css/style.css') }}" rel="stylesheet"> -->
    ...
    @if(!isset($page_type) || (isset($page_type) && $page_type == 'top_products'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group custom_errow ">
                                    ...
                                    <span class="select_arrow-new"><img src="{{ asset('img/custom_arrow.png') }}" class="img-fluid"></span>
                                </div>
                            </div>
...
<form class="dropzone editProductform" id="dropzone_form" data-page="addProductPage" method="POST" action="{{ route('business_user.editproducts')}}" enctype="multipart/form-data">
    @csrf 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-group position-relative">
                                ...
                                <span class="cal-img img_datepicker"><img src="{{ asset('img/calendar_img.png') }}"/></span>
                            </div>
                        </div>
