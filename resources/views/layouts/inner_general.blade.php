...
<!-- Forgot Password Popup --> 
  ...
  <div class="modal fade" id="design_paper" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   ...
   <!--  <script type="text/javascript" src="{{ URL::asset('js/wow.min.js') }}"></script> -->
    ...
    <script type="text/javascript" src="{{ URL::asset('js/general/general_quotes.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/general/general_questions.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/general/formbuilder.js') }}"></script>
