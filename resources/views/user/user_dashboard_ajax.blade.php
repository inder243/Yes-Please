                            ...
                            @foreach($adsToShow as $key=>$adToShow)
                              ...
                              <div class="business_sec">
                                 <div class="b-detail">
                                    ...
                                    <div class="sec_t">
                                       <span class="addtoshowspan" onclick="countClickOfAd('{{$categoryId}}','{{$adToShow['buid']}}','{{$adToShow['campid']}}')"><h1>{{$adToShow['business_name']}}<span><img src="{{ asset('img/verified.png') }}"/></span></h1></span>
