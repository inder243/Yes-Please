    ...
    <header>
        <div class="yesplease_header">
                ...
                <div id="mySidenav" class="sidenav">
                    ...
                    <ul class="custom_sidebar_menu">
                        ...
                        <li>
                          ...
                          <li>
                            <a href="<?php echo e(route('general_user.beforelogin')); ?>"><img src="img/question.png" />I'm a User</a>
                          </li>
                          <li>
                            <a href="<?php echo e(route('business_user.beforelogin')); ?>"><img src="img/profile.png" />I'm a Business! </a>
                          </li>
                          <li>
            ...
            <div class="header_links">
                ...
                <?php else: ?>
                <a href="<?php echo e(route('business_user.beforelogin')); ?>" class="register">Business</a>
                <a href="<?php echo e(route('general_user.beforelogin')); ?>" class="login">Users</a>
                <?php endif; ?>
