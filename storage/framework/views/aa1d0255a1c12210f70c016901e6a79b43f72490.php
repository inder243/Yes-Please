                  ...
                  <div class="quote_question">
                    <div class="qq_main">
                     <ul class="nav nav-tabs">
                        <li class="nav-item">
                           <a class="nav-link <?php if($tab == 'quotes'): ?>active <?php endif; ?>" data-toggle="tab" href="#Quotes">Quotes</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link <?php if($tab == 'ques'): ?>active <?php endif; ?>" data-toggle="tab" href="#Questions">Questions</a>
                        </li>
                     </ul>
                   </div>
                     <!-- Tab panes -->
                     <div class="tab-content">
                        <div class="tab-pane <?php if($tab == 'quotes'): ?>active <?php endif; ?>" id="Quotes">
                            <div class="qq_main">
                           ...
                           <div class="quote_section">
                              ...
                              <?php endif; ?> -->
                                 ...
                                 <div class="quote_detail">
                                    ...
                                    <h1><?php echo e($quote[0]['get_quotes']['cat_name']); ?> Quotes : <?php echo e($quote[0]['get_quotes']['quote_id']); ?></h1>
                              ...
                              <form method="POST" name="ques_keyword_form" id="search_questions" action="">
                                <div class="search_filter">
                                  ...
                                  <div class="row  searchf_input">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                      <label for="inputPassword4">Keyword</label>
                                      <input type="text" class="form-control gen_ques_keyword" id="inputPassword4" value="<?php if(!empty($ques_keyword)): ?><?php echo e($ques_keyword); ?><?php endif; ?>">
                                    </div>
                                    <div class="form-group col-md-6 col-12">
                          ...
                          <?php if(!empty($questions)): ?>
                            ...
                            <div class="quote_section">
                              ...
                              <?php $__currentLoopData = $all_qus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sQuote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($sQuote['get_ques']['status_gen']==3): ?>
                                  <?php $answerdSts = 1; ?>
                                <?php endif; ?>
                                <?php if($sQuote['get_ques']['status_gen']==2): ?>
                                  <?php $readSts = 1; ?>
                                <?php endif; ?>
                                <?php if($sQuote['get_ques']['status_gen']==1): ?>
                                  <?php $newSts = 1; ?>
                                <?php endif; ?>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                              <?php if(isset($answerdSts) && $answerdSts==1): ?>
                              <a href="<?php echo e(url('/general_user/qusreply/'.$question_id)); ?>" class="new_quote q_accepted">
                              <?php elseif(isset($readSts) && $readSts==1): ?>
                              <a href="<?php echo e(url('/general_user/qusreply/'.$question_id)); ?>" class="new_quote q_quoted">
                              <?php elseif(isset($newSts) && $newSts==1): ?>
                              <a href="<?php echo e(url('/general_user/qusreply/'.$question_id)); ?>" class="new_quote">
                              <?php else: ?>
                              <a href="<?php echo e(url('/general_user/qusreply/'.$question_id)); ?>" class="new_quote">
                              <?php endif; ?>
                                   ...
                                   <div class="quote_detail">
                                      ...
                                      ?>
                                        <span>Replies <b><?php echo e($get_total_replies); ?></b></span>
                                        ...
                                        <div class="Q_tag">
                                          ...
                                          <?php endif; ?> 
                                           ...
                                           <div class="created_date"><span class="timedcreated"><?php echo e($time); ?></span><span class="timedcreated_d"><?php echo e($date); ?></span></div>
                                      </div>

                                      <div class="Q_description">
                                        <?php $q_descriptn = mb_strimwidth($all_qus[0]['get_ques']['q_title'], 0, 150, "..."); ?>
