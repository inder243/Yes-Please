...
<div class="maindivForSections">
  <section class="register_step_1">
    <div class="breadcrumb register_breadcrumb advertisment_breadcrumb">
      ...
      <a href="<?php echo e(url('/business_user/edit_budget')); ?>">Edit budget</a>
      </div>
    </div>
  </section>
          ...
          <div class="col-md-3 col-6 padding_lt">
            <div class="dashboard_box">
                <a href="<?php echo e(url('/business_user/advertisement_top_ads')); ?>" class="interactions_today_bg">
                  ...
                  <div class="total_number">
                    <h1><?php if(isset($monthlyBudget['countOfTopAd'])): ?><?php echo e($monthlyBudget['countOfTopAd']); ?><?php endif; ?></h1>
                  </div>
                    <div class="Qlink-nis"><p><?php if(isset($monthlyBudget['sumOfTopAd'])): ?><?php echo e($monthlyBudget['sumOfTopAd']); ?><?php endif; ?> NIS</p>
