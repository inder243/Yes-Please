...
<section class="register_step_1">
  <input type="hidden" id="hidden_catId" name="catIdhidd" value="<?php echo e($categoryId); ?>">
                      ...
                      <?php if(isset($adsToShow) && !empty($adsToShow)): ?>
                        <ul class="all_bus_by_cat" id="all_busBy_cat_ads">
                            ...
                            <?php $__currentLoopData = $adsToShow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$adToShow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li class="all_business_bycat_li"  data-cat-id="<?php echo e($categoryId); ?>" data-camp-id="<?php echo e($adToShow['campid']); ?>" style="border-color: #ffcb08 !important;">
                              ...
                              <div class="business_sec">
                                 <div class="b-detail">
                                    ...
                                    <div class="sec_t">
                                       <span class="addtoshowspan" onclick="countClickOfAd('<?php echo e($categoryId); ?>','<?php echo e($adToShow['buid']); ?>','<?php echo e($adToShow['campid']); ?>')"><h1 datacamp="<?php echo e($adToShow['campid']); ?>"><?php echo e($adToShow['business_name']); ?>  <?php echo e($adToShow['camp_name']); ?><span><img src="<?php echo e(asset('img/verified.png')); ?>"/></span></h1></span>
