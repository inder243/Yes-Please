        ...
        <div class="yep_section_bg">
            <div class="product_detail" data-skip="7">
                ...
                <div class="finance wow flipInX" data-wow-duration="1.5s">
                    <a href="<?=$home_url;?>/category-classifcation/<?php echo e($categories[0]['super_cat_id']); ?>" /><span class="fiance_icon"><img src="<?php echo e(asset('img/finance.png')); ?>" class="img-fluid finance_img"/><img src="<?php echo e(asset('img/finance_active.png')); ?>" class="img-fluid finance_active"/> </span><span class="catagory_name"><?php echo e($categories[0]['cat_name']); ?></span></a>
                </div>
                <?php endif; ?>
                <?php if(isset($categories[1])): ?>
                <div class="energy">
                    <a href="<?=$home_url;?>/category-classifcation/<?php echo e($categories[1]['super_cat_id']); ?>" /><span class="energy_icon"><img src="<?php echo e(asset('img/energy.png')); ?>" class="img-fluid energy_img"/><img src="<?php echo e(asset('img/energy_active.png')); ?>" class="img-fluid energy_active"/> </span><span class="energy_name"><?php echo e($categories[1]['cat_name']); ?></span></a>
                </div>
                <?php endif; ?>
                <?php if(isset($categories[2])): ?>
                <div class="travel wow zoomIn" data-wow-duration="1s">
                    <a href="<?=$home_url;?>/category-classifcation/<?php echo e($categories[2]['super_cat_id']); ?>" /><span class="travel_icon"><img src="<?php echo e(asset('img/travel.png')); ?>" class="img-fluid travel_img"/><img src="<?php echo e(asset('img/travel_active.png')); ?>" class="img-fluid travel_active"/> </span><span class="travel_name"><?php echo e($categories[2]['cat_name']); ?></span></a>
                </div>
                <?php endif; ?>
                <?php if(isset($categories[3])): ?>
                <div class="telco">
                    <a href="<?=$home_url;?>/category-classifcation/<?php echo e($categories[3]['super_cat_id']); ?>" /><span class="telco_icon"><img src="<?php echo e(asset('img/telco.png')); ?>" class="img-fluid telco_img"/><img src="<?php echo e(asset('img/telco_active.png')); ?>" class="img-fluid telco_active"/> </span><span class="telco_name"><?php echo e($categories[3]['cat_name']); ?></span></a>
                </div>
                <?php endif; ?>
                ...
                <div class="eNews">
                    <a href="<?=$home_url;?>/category-classifcation/<?php echo e($categories[4]['super_cat_id']); ?>" /><span class="eNews_icon"><img src="<?php echo e(asset('img/enews.png')); ?>" class="img-fluid eNews_img"/><img src="<?php echo e(asset('img/enews_active.png')); ?>" class="img-fluid eNews_active"/> </span><span class="eNews_name"><?php echo e($categories[4]['cat_name']); ?></span></a>
                </div>
                <?php endif; ?>
                <?php if(isset($categories[5])): ?>
                <div class="entertainment wow zoomIn" data-wow-duration="1s">
                    <a href="<?=$home_url;?>/category-classifcation/<?php echo e($categories[5]['super_cat_id']); ?>" /><span class="entertainment_icon"><img src="<?php echo e(asset('img/entertainment.png')); ?>" class="img-fluid entertainment_img"/><img src="<?php echo e(asset('img/entertainment_active.png')); ?>" class="img-fluid entertainment_active"/> </span><span class="entertainment_name"><?php echo e($categories[5]['cat_name']); ?></span></a>
                </div>
                <?php endif; ?>
                <?php if(isset($categories[6])): ?>
                <div class="category">
                    <a href="<?=$home_url;?>/category-classifcation/<?php echo e($categories[6]['super_cat_id']); ?>" /><span class="category_icon"><img src="<?php echo e(asset('img/category.png')); ?>" class="img-fluid category_img"/><img src="<?php echo e(asset('img/category_active.png')); ?>" class="img-fluid category_active"/> </span><span class="cat_name"><?php echo e($categories[6]['cat_name']); ?></span></a>
                </div>
                <?php endif; ?>
            </div>
        </div>
